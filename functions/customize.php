...
function kolumn_customizer( $wp_customize ) {
    ...
    /* AVATAR IMAGE */
    $wp_customize->add_setting('logo', array('default' => get_template_directory_uri().'/images/logo-baramochis.png'));
    $wp_customize->add_control(new WP_Customize_Image_Control($wp_customize, 'logo', array(
        'label' => __( 'Logo', 'elenatheme' ),
        'section' => 'style',
        'settings' => 'logo'
    )));

    /* BACKGROUND PICTURE*/
    $wp_customize->add_setting('bg_picture', array('default' => get_template_directory_uri().'/images/fond-mochi1.png'));
    $wp_customize->add_control(new WP_Customize_Image_Control($wp_customize, 'bg_picture', array(
        'label' => __( 'Photo de fond', 'elenatheme' ),
        'section' => 'style',
        'settings' => 'bg_picture'
    )));
